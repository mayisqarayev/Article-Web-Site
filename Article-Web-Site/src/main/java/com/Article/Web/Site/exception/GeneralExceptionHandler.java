...
public class GeneralExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public Map<String, Object> handleCommentNotFoundException(CommentNotFoundException ex, WebRequest webRequest) {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public Map<String, Object> handleFollowNotFoundException(FollowNotFoundException ex, WebRequest webRequest) {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public Map<String, Object> handleRoleNotFoundException(RoleNotFoundException ex, WebRequest webRequest) {
